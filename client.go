...
const (
	...
	userAgent      = "website-contacts-go/" + libraryVersion
	mediaType      = "application/json"
)

// defaultWContactsURL is the default Website Contacts API URL.
const defaultWContactsURL = `https://website-contacts.whoisxmlapi.com/api/v1`
...
func NewClient(apiKey string, params ClientParams) *Client {
	...
	apiBaseURL := params.WContactsBaseURL
	if apiBaseURL == nil {
		apiBaseURL, err = url.Parse(defaultWContactsURL)
		if err != nil {
			panic(err)
		}
	}
	...
	client.WContactsService = &wContactsServiceOp{client: client, baseURL: apiBaseURL}
